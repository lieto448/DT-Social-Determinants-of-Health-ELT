...
SELECT
    ...
    FOREIGN KEY (finance_id) REFERENCES dim_finance(finance_id),
    FOREIGN KEY (groceries_id) REFERENCES dim_groceries(groceries_id),
    FOREIGN KEY (habbits_id) REFERENCES dim_habbits(habbits_id),
    FOREIGN KEY (occupation_id) REFERENCES dim_occupation(occupation_id),
    FOREIGN KEY (wellness_id) REFERENCES dim_wellness(wellness_id),
    FOREIGN KEY (home_id) REFERENCES dim_home_envoroment(home_id)
FROM sdoh_extarct s
JOIN dim_diet d ON fact_household.diet_id = d.diet_id
JOIN dim_finance f ON fact_household.finance_id = f.finance_id
JOIN dim_groceries g ON fact_household.groceries_id = g.groceries_id
JOIN dim_habbits h ON fact_household.habbits_id = h.habbits_id
JOIN dim_occupation o ON fact_household.occupation_id = o.occupation_id
JOIN dim_wellness w ON fact_household.wellness_id = w.wellness_id
JOIN dim_home_enviroment he w ON fact_household.home_id = he.home_id
